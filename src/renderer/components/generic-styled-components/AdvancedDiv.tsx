...
const HoverDiv = styled.div`
  ...
  &:hover {
    border-width: ${(props: IHoverDivProps): string =>
      props.hasBorder
        ? props.borderWidth
          ? props.borderWidth
          : '2px'
        : '0px'};
    border-color: ${(props: IHoverDivProps): string =>
      props.hasBorder
        ? props.borderColor
          ? props.borderColor
          : '#ffffff'
        : 'transparent'};
    border-style: ${(props: IHoverDivProps): string =>
      props.hasBorder
        ? props.borderType
          ? props.borderType
          : 'solid'
        : 'none'};
    border-radius: ${(props: IHoverDivProps): string =>
      props.hasBorder
        ? props.borderRadius
          ? props.borderRadius
          : '0px'
        : '0px'};
    cursor: ${(props: IHoverDivProps): string =>
      props.cursor ? props.cursor : 'none'};
  }
`;
